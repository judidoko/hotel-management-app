...
const FeaturedRoom: FC<Props> = (props) => {
  ...
  return (
    <>
      <section className="container flex md:flex-row flex-col px-4 py-10 items-center gap-12">
        ...
        <div className="md:py-10 md:w-1/2 text-left">
          ...
          <h2 className="mb-4 text-2xl">{featuredRoom.name}</h2>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
            <div className="flex mb-3 md:mb-0">
              <div className="flex gap-3 flex-col items-center justify-center mr-4">
                ...
                <p className="md:font-bold flex font-medium text-lg xl:text-4xl">
                  &#8358;
                  {featuredRoom.price
                    .toString()
                    .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
              ...
              <div className="flex gap-3 flex-col items-center justify-center mr-4">
                ...
                <p className="md:font-bold flex font-medium text-red-500 text-lg xl:text-4xl">
                  <s>
                    &#8358;

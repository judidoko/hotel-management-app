...
const HotelGallery: FC<{ photos: ImageType[] }> = ({ photos }) => {
  ...
  // Function to swipe to the left or right
  ...
  // Getting the number of images to show
            ...
            {remainingPhotosCount > 0 && (
              ...
              >
                <Image
                  ...
                  className="img"
                />
                <div className="absolute cursor-pointer text-white inset-0 flex justify-center items-center bg-[rgba(0,0,0,0.5)] text-2xl">
